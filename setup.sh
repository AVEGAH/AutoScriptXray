...
echo -e "$BYellow----------------------------------------------------------$NC"
echo -e "$BGreen 1. Use Random Domain / Gunakan Domain Random $NC"
echo -e "$BGreen 2. Choose Your Own Domain / Gunakan Domain Sendiri $NC"
echo -e "$BYellow----------------------------------------------------------$NC"
read -rp " input 1 or 2 / pilih 1 atau 2 : " dns
if test $dns -eq 1; then
wget https://raw.githubusercontent.com/AVEGAH/AutoScriptXray/master/ssh/cf && chmod +x cf && ./cf
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/AVEGAH/AutoScriptXray/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/AVEGAH/AutoScriptXray/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/AVEGAH/AutoScriptXray/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/AVEGAH/AutoScriptXray/master/menu/versi  )
...
echo "|MMMMM  AAAA  PPPPP  TTTTT EEEEE CCCCC  H   H|                       "  | tee -a log-install.txt
echo "|M   M A   A P   P    T   E     C      H   H|                       "  | tee -a log-install.txt
echo "|MMMMM AAAAA PPPP     T   EEE   C      HHHHH|                       "  | tee -a log-install.txt
echo "|M   M A   A P        T   E     C      H   H|                       "  | tee -a log-install.txt
echo "|M   M A   A P        T   EEEEE CCCCC  H   H|                       "  | tee -a log-install.txt
echo "=================================================================="  | tee -a log-install.txt
echo ""
